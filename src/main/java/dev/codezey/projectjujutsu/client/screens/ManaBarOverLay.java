...
public class ManaBarOverLay {
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        int posX = w / 2;
        int posY = h / 2;
        int mana = ManaBarData.getPlayerMana() + 5;
        Level world = null;
        double x = 0;
        double y = 0;
        double z = 0;
        ...
        if (true) {
            ...
            event.getGuiGraphics().blit(new ResourceLocation("jujutsu:textures/screens/fullbar.png"), posX - 260, posY, 0, 0,  mana +5, 54, 105, 54);
        }
